...
dey_PN_list = emit_growth_phase_noise(betay, Vcc, frev, Eb, myC_PN_list, ssb_2_dsb(PSD_PN), True)  # true for one-sided PSD
dey_AN_list = emit_growth_amplitude_noise(betay, Vcc, frev, Eb, myC_AN_list, ssb_2_dsb(PSD_AN), True)
