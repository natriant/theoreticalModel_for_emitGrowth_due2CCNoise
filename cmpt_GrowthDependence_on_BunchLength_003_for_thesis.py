...
PSD_PN_list = [-122.6, -101.4, -115.0, -111.4, -110.9, -106.4, -101.4] # PSD values at fb in dBc/Hz
PSD_AN_list = [-128.1, -115.2, -124.1, -115.7, -116.9, -112.9, -106.9]
...
print(f'First bunch length value: {sigma_t_list[0]} seconds')
...
# For thesis plot only the first bunch
sigma_t_points = [(1.7e-9)/4]
